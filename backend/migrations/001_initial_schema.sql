...
-- Description: Creates the initial database schema for Performance Metrics System
...
---- Down Migration (everything below this line will be run for down migrations)
-- @down
...
DROP INDEX IF EXISTS idx_metric_definitions_category;
DROP INDEX IF EXISTS idx_metric_values_recorded_at;
DROP INDEX IF EXISTS idx_metric_values_metric_date;
